...
export default function Footer() {
  return (
    ...
    //         </p>
    //         <div className="flex gap-4 md:flex gap-4">
  ...
  <div className="max-w-7xl mx-auto">
    <div className="mb-16">
      ...
      {/* Brand Info - centered on mobile, hidden on desktop (shown in grid below) */}
      <div className="flex flex-col items-center md:hidden mb-10">
        <div className="flex items-center gap-2 mb-6">
          <img src="/images/logo.png" alt="Kiddo Logo" className="w-16 h-16 object-contain" referrerPolicy="no-referrer" />
        </div>
        <p className="text-white-400 mb-8 leading-relaxed text-center max-w-xs">
          Premium baby essentials trusted by 50,000+ parents across India.
        </p>
      ...
      {/* Desktop: 4 col grid | Mobile: 2 col grid for links only */}
      ...
      {/* Mobile: 2 col grid for links only */}
    ...
    <div className="pt-8 border-t border-gray-800 text-center text-white-500 text-sm">
      <p>© {new Date().getFullYear()} Kiddo Baby Products. All rights reserved.</p>
    </div>
  </div>
</footer>
